...
import template from "assets/template/RegistrationStudentTemplate.csv"
...
class CreateStudentAccount extends React.Component {
    ...
    onFileUpload(){
        try {
            ...
            axios.post(url + "/register-student", formData).then(res => {
                    ...
                    <Container className="py-lg-md d-flex">
                        ...
                        <Row>
                            ...
                            <h1 className="display-3 text-white">
                                Buat Akun Siswa / Mahasiswa
                            </h1>

                            <div className="btn-wrapper">

                                <a href={template} download="Template Registrasi Siswa" >
                                    <Button
